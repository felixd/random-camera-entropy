...
from app.reporting.unicode_image_text import font_path, unicode_font
...
def main() -> int:
    ...
    control_source = (Path(server.__file__).resolve().parents[1] / "control" / "control_server.py").read_text(encoding="utf-8")
