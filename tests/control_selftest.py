...
from app.control.control_server import (
    ALLOWED_PROFILES,
    JobManager,
    Settings,
    create_app,
...
def main() -> int:
    with tempfile.TemporaryDirectory() as raw:
        ...
        assert ALLOWED_PROFILES["dual-weave-stagger2"] == "scripts/smoke/smoke_dual_weave_stagger2.sh"
        assert ALLOWED_PROFILES["temporal-sha3"] == "scripts/smoke/smoke_temporal_sha3.sh"
        assert ALLOWED_PROFILES["production-assessment"] == "scripts/qualification/production_assessment.sh"
        assert ALLOWED_PROFILES["final-preproduction"] == "scripts/qualification/final_preproduction.sh"
