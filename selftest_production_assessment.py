...
from qualification_production_assessment import build_cases
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as temporary:
        ...
        subprocess.run(["python3", str(ROOT / "summarize_production_assessment.py"), str(campaign)], check=True, stdout=subprocess.DEVNULL)
