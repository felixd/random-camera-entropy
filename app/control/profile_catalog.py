...
PROFILE_DEFINITIONS: dict[str, dict[str, Any]] = {
    "final-preproduction": {
        "script": "scripts/qualification/final_preproduction.sh",
    ...
    "production-assessment": {
        "script": "scripts/qualification/production_assessment.sh",
    ...
    "qualification": {
        "script": "scripts/qualification/qualification_preproduction.sh",
    ...
    "cold-start": {
        "script": "scripts/qualification/qualification_cold_start_run.sh",
    ...
    "production-safe": {
        "script": "scripts/run/run_production.sh",
    ...
    "temporal-sha3": {
        "script": "scripts/smoke/smoke_temporal_sha3.sh",
    ...
    "smoke": {
        "script": "scripts/smoke/smoke_preproduction.sh",
    ...
    "lsb-campaign": {
        "script": "scripts/smoke/smoke_lsb_profiles.sh",
    ...
    "spatial-campaign": {
        "script": "scripts/smoke/smoke_spatial_profiles.sh",
    ...
    "dual-weave-lags": {
        "script": "scripts/smoke/smoke_dual_weave_lags.sh",
    ...
    "global-all": {
        "script": "scripts/qualification/qualification_global_all_profiles.sh",
    ...
    "spatial-phases": {
        "script": "scripts/smoke/smoke_checkerboard_phases.sh", "label": "Spatial — checkerboard phases smoke", "category": "Maski i geometria",
        "help": "Porównanie obu faz szachownicy.", "preset": {"spatial_mask_pattern": "legacy", "spatial_sampling": "checkerboard-even"},
    },
    "spatial-baseline": {
        "script": "scripts/smoke/smoke_spatial_baseline.sh", "label": "Spatial — baseline full / row-major", "category": "Maski i geometria",
    ...
    "spatial-checker-even": {
        "script": "scripts/smoke/smoke_spatial_checkerboard_even.sh", "label": "Spatial — checkerboard even", "category": "Maski i geometria",
        "help": "Parzysta faza szachownicy.", "preset": {"spatial_mask_pattern": "checkerboard-even", "spatial_sampling": "checkerboard-even"},
    },
    "spatial-checker-odd": {
        "script": "scripts/smoke/smoke_spatial_checkerboard_odd.sh", "label": "Spatial — checkerboard odd", "category": "Maski i geometria",
        "help": "Nieparzysta faza szachownicy.", "preset": {"spatial_mask_pattern": "checkerboard-odd", "spatial_sampling": "checkerboard-odd"},
    },
    "spatial-grid2": {
        "script": "scripts/smoke/smoke_spatial_grid_2x2.sh", "label": "Spatial — grid 2×2", "category": "Maski i geometria",
    ...
    "spatial-grid4": {
        "script": "scripts/smoke/smoke_spatial_grid_4x4.sh", "label": "Spatial — grid 4×4", "category": "Maski i geometria",
    ...
    "spatial-block4": {
        "script": "scripts/smoke/smoke_spatial_block_4x4_phase_1_2.sh", "label": "Spatial — block 4×4, faza (1,2)", "category": "Maski i geometria",
    ...
    "spatial-offset11": {
        "script": "scripts/smoke/smoke_spatial_offset_diagonal_1.sh", "label": "Spatial — offset XOR (+1,+1)", "category": "Maski i geometria",
    ...
    "spatial-offset22": {
        "script": "scripts/smoke/smoke_spatial_offset_diagonal_2.sh", "label": "Spatial — offset XOR (+2,+2)", "category": "Maski i geometria",
    ...
    "spatial-serpentine": {
        "script": "scripts/smoke/smoke_spatial_serpentine.sh", "label": "Spatial — serializacja serpentine", "category": "Maski i geometria",
        "help": "Naprzemienny kierunek wierszy.", "preset": {"spatial_mask_pattern": "full", "serialization_order": "serpentine"},
    },
    "spatial-tile16": {
        "script": "scripts/smoke/smoke_spatial_tile_interleave_16.sh", "label": "Spatial — tile interleave 16×16", "category": "Maski i geometria",
    ...
    "dual-weave": {
        "script": "scripts/smoke/smoke_dual_weave.sh", "label": "Dual Weave — równoległy smoke", "category": "Eksperymentalne",
    ...
    "dual-weave-stagger2": {
        "script": "scripts/smoke/smoke_dual_weave_stagger2.sh", "label": "Dual Weave — row-major / stagger-2", "category": "Eksperymentalne",
    ...
    "dual-weave-stagger-qualification": {
        "script": "scripts/qualification/qualification_dual_weave_stagger.sh", "label": "Dual Weave — kwalifikacja stagger-2", "category": "Eksperymentalne",
